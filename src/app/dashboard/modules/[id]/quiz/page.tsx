...
export default function ModuleQuizPage() {
  ...
  const { data: trainingModule, loading, error, refetch } =
    useFetch<ModuleWithQuiz>(`/api/modules/${moduleId}`);
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (res.passed) {
        ...
        toast('You did not pass this time. Review your answers and try again.', { icon: '📝' });
      }
    } catch (err) {
      ...
      <div className="page-container">
        <div className="glass-card p-8 border-red-500/30 text-center">
          ...
          <div className="flex justify-center gap-3">
            <Link href={`/dashboard/modules/${moduleId}`} className="btn-secondary">
    ...
    return (
      <div className="page-container">
        <div className="glass-card p-8 text-center">
          ...
          <p className="text-gray-400 mb-4">This module does not have a quiz yet.</p>
          <Link href={`/dashboard/modules/${moduleId}`} className="btn-primary">
            <ArrowLeft className="w-4 h-4 mr-2" /> Back to Module
          </Link>
        </div>
      </div>
    ...
    return (
      <div className="page-container">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-white mb-2">{quiz.title || 'Module Quiz'}</h1>
          <p className="text-gray-400 mb-6">Test your knowledge of {trainingModule.title}</p>
    ...
    return (
      <div className="page-container space-y-6">
        ...
        >
          ...
          <div className="flex justify-center gap-3">
            <Link href={`/dashboard/modules/${moduleId}`} className="btn-secondary inline-flex items-center gap-2">
              <ArrowLeft className="w-4 h-4" /> Back to Module
            </Link>
            {!result.passed && (
